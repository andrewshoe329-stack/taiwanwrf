...
// Inline Taiwan GeoJSON — avoids a fetch that can fail in production
const TAIWAN_GEOJSON: GeoJSON.FeatureCollection = {
  type: 'FeatureCollection',
  features: [
    {
      type: 'Feature', properties: { name: 'Taiwan' },
    ...
    {
      type: 'Feature', properties: { name: 'Penghu' },
      geometry: { type: 'Polygon', coordinates: [[

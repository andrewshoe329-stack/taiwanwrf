...
export const SPOTS: SpotInfo[] = [
  ...
  { id: 'jinshan',     name: { en: 'Jinshan',      zh: '金山' },   lat: 25.2402433645372, lon: 121.63355732190196, facing: 'NE',    region: 'north',     opt_wind: ['S','SW'],        opt_swell: ['N','NNE','NE','E','ESE'], webcams: [{ label: '中角灣', url: 'https://tw.live/cam/?id=zhongjiaobay' }, { label: '國海院', url: 'https://tw.live/cam/?id=gjhyyjyzjw' }] },
  { id: 'greenbay',    name: { en: 'Green Bay',    zh: '翡翠灣' }, lat: 25.18952488598986, lon: 121.68580407087968, facing: 'NE',    region: 'north',     opt_wind: ['W','SW'],        opt_swell: ['E','NE'], webcams: [{ label: '翡翠灣', url: 'https://tw.live/cam/?id=CCTV-11-0020-048-010' }] },
  { id: 'fulong',      name: { en: 'Fulong',      zh: '福隆' },   lat: 25.02389886806093, lon: 121.94298998527262, facing: 'NE/E',  region: 'north',     opt_wind: ['S','SW'],        opt_swell: ['N','NE','E'], webcams: [{ label: '福隆', url: 'https://www.necoast-nsa.gov.tw/Live-Streaming-Content.aspx?a=3299&l=1' }, { label: '福隆2', url: 'https://iii.tw/necoast/4001.html' }] },
  // NE coast (N→S along coast: Daxi → Double Lions → Wushih → Chousui)
  { id: 'daxi',        name: { en: 'Daxi',         zh: '大溪' },   lat: 24.93284050868701, lon: 121.88580048320033, facing: 'SE',    region: 'northeast', opt_wind: ['NW','W'],        opt_swell: ['SE','SSE','S','E'], webcams: [{ label: '大溪漁港', url: 'https://tw.live/cam/?id=1141509904' }] },

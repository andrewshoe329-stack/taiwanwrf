...
export const SPOTS: SpotInfo[] = [
  ...
  { id: 'jinshan',     name: { en: 'Jinshan',      zh: '金山' },   lat: 25.2402433645372, lon: 121.63355732190196, facing: 'NE',    region: 'north',     opt_wind: ['S','SW'],        opt_swell: ['N','NNE','NE','E','ESE'], webcam: 'https://tw.live/cam/?id=zhongjiaobay' },
  ...
  { id: 'doublelions', name: { en: 'Double Lions',  zh: '雙獅' },   lat: 24.888936271482883, lon: 121.85002306336393, facing: 'E',     region: 'northeast', opt_wind: ['W','SW'],        opt_swell: ['ENE','E','SE','SSE'], webcam: 'https://tw.live/cam/?id=waiaobeach' },
  { id: 'wushih',      name: { en: 'Wushih',       zh: '烏石' },   lat: 24.8722775159955, lon: 121.84152686026746, facing: 'E',     region: 'northeast', opt_wind: ['NW','W'],        opt_swell: ['E','SE','SSE'], webcam: 'https://tw.live/cam/?id=zyqxjylwajsyx1' },

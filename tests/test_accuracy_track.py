...
class TestComputeAccuracy:
    ...
    def test_no_overlap(self):
        ...
        obs = {'hourly': {'time': ['2026-03-23T00:00'], 'temperature_2m': [21], 'wind_speed_10m': [12],
                          'wind_direction_10m': [180], 'precipitation': [0]}}
    ...
    def test_perfect_forecast(self):
        ...
        obs = {'hourly': {'time': ['2026-03-22T06:00'], 'temperature_2m': [20.0],
                          'wind_speed_10m': [10.0], 'wind_direction_10m': [180], 'precipitation': [0]}}
